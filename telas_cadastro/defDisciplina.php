...
<body>
	<div id='wrapper'>
		...
		<div id='page-wrapper'>
            <div class='row'>
                <div class='col-lg-12'>
                    <h1 class='page-header'>Cadastro de Disciplina no Projeto</h1>
                </div>
            </div>
			";
			if($con){
								...
								<div class='col-lg-12'>
									<div class='jumbotron'>
										<center>
											...
											<p>	Registro de projeto + disciplina já existe.<br/><br/>
												Tente novamente.
											</p>
										</center>
									</div>
						...
						<div class='row'>
							<div class='col-lg-12'>
								<div class='jumbotron'>
									<center>
										<h1><i class='fa fa-graduation-cap fa-3x'></i></h1>
										<p>	Codigo de disciplina não localizado.<br/><br/>
											Tente novamente.
										</p>
									</center>
								</div>
						...
						<div class='row'>
							<div class='col-lg-12'>
								<div class='jumbotron'>
									<center>
										<h1><i class='fa fa-graduation-cap fa-3x'></i></h1>
										<p>	Numero de projeto não localizado.<br/><br/>
											Tente novamente.
										</p>
									</center>
								</div>
