...
<body>
	<div id='wrapper'>
		...
		<div id='page-wrapper'>
						...
						<div class='col-lg-12'>
							<div class='jumbotron'>
								<center>
									...
									<p>	Usuario jah cadastrado.<br/><br/>
										Tente novamente.
									</p>
								</center>
							</div>
					...
					<div class='row'>
						<div class='col-lg-12'>
							<div class='jumbotron'>
								<center>
									<h1><i class='fa fa-graduation-cap fa-3x'></i></h1>
									<p>	Usuário cadastrado com sucesso!<br/>
									</p>
								</center>
							</div>
						</div>
			...
			<div class='row'>
				<div class='col-xs-12'>
					<a class='btn btn-danger btn3d' type='button' href='cadUsuario.html'>Voltar <i class='fa fa-times'></i></a>
