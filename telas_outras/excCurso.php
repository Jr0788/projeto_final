	...
	<html lang=pt-br>
		...
		<body>
			...
			<div id='main' class='container-fluid'>
				<h3 class='page-header'>Excluir Curso</h3>
			</div>
			<div class='form-group col-md-4'>";
				if($con){
					$consulta = "SELECT * FROM curso WHERE numero = '" . $numer . "'";
					$resultado = pg_query($con, $consulta);
					$num = pg_num_rows($resultado);
							
					if ($num > 0){
						$consulta = "DELETE FROM curso WHERE numero = '" . $numer ."'";
						$resultado = pg_query($con, $consulta);
						echo "Curso excluido com sucesso!<br/>";
					}else{
						echo "Curso nao localizado!</br>";
			...
			<div id='actions' class='row'>
				<div class='col-md-12'>
					&emsp;&emsp;&emsp;&emsp;<a href=excCurso.html class='btn btn-default'> Voltar</a>
