<?php
	...
	$log = isset($_GET["tLogin"]) ? $_GET["tLogin"] : null;
	...
	<html lang=pt-br>
		...
		<body>
			...
			<div id='main' class='container-fluid'>
				<h3 class='page-header'>Excluir Usuario</h3>
			</div>
			<div class='form-group col-md-4'>";
				if($con){
					$consulta = "SELECT * FROM usuario WHERE login = '" . $log . "'";
					$resultado = pg_query($con, $consulta);
					$num = pg_num_rows($resultado);
							
					if ($num > 0){
						$consulta = "DELETE FROM usuario WHERE login = '" . $log ."'";
						$resultado = pg_query($con, $consulta);
						echo "Usuario excluido com sucesso!<br/>";
					}else{
						echo "Usuario nao localizado!</br>";
			...
			<div id='actions' class='row'>
				<div class='col-md-12'>
					&emsp;&emsp;&emsp;&emsp;<a href=excUsuario.html class='btn btn-default'> Voltar</a>
