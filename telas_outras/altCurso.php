	...
	<html lang=pt-br>
		...
		<body>
			...
			<div id=main class=container-fluid>
			 <h3 class=page-header>Alteracao de Curso</h3>
			</div>
			<div id=main class=container-fluid>
				<br/>";
>>>>>>> origin/master
...
<<<<<<< HEAD
						echo "<br/><br/>
							<div class='row'>
								<div class='col-lg-12'>
									<h1 class='page-header'>Curso alterado com sucesso!</h1>
								</div>
							</div>
						";
					}else{
						echo "<br/><br/>
							<div class='row'>
								<div class='col-lg-12'>
									<h1 class='page-header'>Curso não encontrado.</h1><br/>
...
=======
						echo "<br/><br/>";
						echo "<h3 class=page-header><br/><br/>Curso alterado com sucesso!</h3>";
					}else{
						echo "<br/><br/>";
						echo "<h3 class=page-header>&emsp;&emsp;Curso nao encontrado.</h3>";
				...
				<div id=actions class=row>
					<div class=col-md-12>
						<a href=altCurso.html class='btn btn-default'>Voltar</a>
