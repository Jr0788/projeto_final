<?php
	...
	if($ordem == 'L'){
		$resultado = pg_query ($con , "select * from usuario order by 1");
	}
	elseif($ordem == 'N'){
		$resultado = pg_query ($con , "select * from usuario order by 3");
	}
	else{
		$resultado = pg_query ($con , "select * from usuario order by 4 desc");
	}
	...
	<html lang=pt-br>
		...
		<body>
			...
			<div class='form-group col-md-4'>
				...
				<table border='1'>
					<tr><th>Login&emsp;</th><th>Senha&emsp;</th><th>Nome&emsp;</th><th>Categoria&emsp;</th><th>Situacao&emsp;</th></tr>";
					while ($row=pg_fetch_row($resultado)) {
					  echo "<tr>";
					  echo "<td>".$row[0]."&emsp;</td><td>".$row[1]."&emsp;</td><td>".$row[2]."&emsp;</td><td>".$row[3]."&emsp;</td><td>".$row[4]."&emsp;</td>";
					  echo "</tr>";
					}
				echo "</table>";
				pg_close($con);
			...
			<div id='actions' class='row'>
				<div class='col-md-12'>
					&emsp;&emsp;&emsp;&emsp;<a href=listUsuario.html class='btn btn-default'> Voltar</a>
