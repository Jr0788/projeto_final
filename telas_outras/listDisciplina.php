<?php
	...
	if($ordem == 'C'){
		$resultado = pg_query ($con , "select * from disciplina order by 1");
	}
	elseif($ordem == 'N'){
		$resultado = pg_query ($con , "select * from disciplina order by 2");
	}
	else{
		$resultado = pg_query ($con , "select * from disciplina order by 3 desc");
	}
	...
	<html lang=pt-br>
		...
		<body>
			...
			<div id='main' class='container-fluid'>
				<h3 class='page-header'>Consulta Disciplina</h3>
			</div>
			<div class='form-group col-md-4'>
				Veja abaixo a Lista:<br/><br/>
				<table border='1'>
					<tr><th>Codigo&emsp;</th><th>Nome&emsp;</th><th>Carga Horaria&emsp;</th></tr>";
			...
			<div id='actions' class='row'>
				<div class='col-md-12'>
					&emsp;&emsp;&emsp;&emsp;<a href=listDisciplina.html class='btn btn-default'> Voltar</a>
