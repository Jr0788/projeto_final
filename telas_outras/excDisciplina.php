<?php
	...
	$numer = isset($_GET["nNum"]) ? $_GET["nNum"] : null;
	...
	<html lang=pt-br>
		...
		<body>
			...
			<div id='main' class='container-fluid'>
				<h3 class='page-header'>Excluir Disciplina</h3>
			</div>
			<div class='form-group col-md-4'>";
				if($con){
					$consulta = "SELECT * FROM disciplina WHERE codigo = " . $numer;
					$resultado = pg_query($con, $consulta);
					$num = pg_num_rows($resultado);
							
					if ($num > 0){
						$consulta = "DELETE FROM disciplina WHERE codigo = " . $numer;
						$resultado = pg_query($con, $consulta);
						echo "Disciplina excluida com sucesso!<br/>";
					}else{
						echo "Disciplina nao localizada!</br>";
			...
			<div id='actions' class='row'>
				<div class='col-md-12'>
					&emsp;&emsp;&emsp;&emsp;<a href=excDisciplina.html class='btn btn-default'> Voltar</a>
