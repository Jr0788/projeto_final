...
<body>
	<div id='wrapper'>
        ...
        <div id='page-wrapper'>
            <div class='row'>
                <div class='col-lg-12'>
                    <h1 class='page-header'>Alteração de disciplina</h1>
                </div>
            </div>";
				if($con){
					...
					if($num > 0){
						...
						echo "<br/><br/>
							<div class='row'>
								<div class='col-lg-12'>
									<h1 class='page-header'>Disciplina alterada com sucesso!</h1>
								</div>
							</div>
						";
					}else{
						echo "<br/><br/>
							<div class='row'>
								<div class='col-lg-12'>
									<h1 class='page-header'>Disciplina não encontrada.</h1><br/>
